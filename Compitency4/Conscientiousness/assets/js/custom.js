...
var imgNavigation = 
{
    ...
    { 
        ...
        if(imgNavigation.count<=6) 
        {
            $(".img_prev_Btn").css("opacity","1");
            $(".img_prev_Btn").css("cursor","pointer"); 
            $(".img_prev_Btn").css("pointer-events","all");
            ...
            if(imgNavigation.count==6)
            {
                ...
                $(".img_next_Btn").css("pointer-events","none");
            }
        }
        else
        {
            imgNavigation.count= 6
        }
    ...
    {         
        ...
        if(imgNavigation.count>=0) 
        {
            ...
            $(".img_next_Btn").css("pointer-events","all");
            $(this).parent().parent().parent().parent().hide();
            ...
            if(imgNavigation.count==0)
            {
                $(".img_prev_Btn").css("opacity",".5");
                $(".img_prev_Btn").css("cursor","default"); 
                $(".img_prev_Btn").css("pointer-events","none");
            }
        }
        else        
        {
