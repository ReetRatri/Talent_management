$(document).ready(function(){
    ...
    {
        $(this).attr("src","assets/images/Arrow_Right2.png")
    })

    $(".approch_img").on("mouseout",function()
    {
        $(this).attr("src","assets/images/Arrow_Right.png")
    })
...
var imgNavigation = 
{
    ...
    init:function()
    {
        ...
        $(".carosel01 .img_prev_Btn").css("opacity",".5");
        $(".carosel01 .img_prev_Btn").css("cursor","default");
    },
    
    buttonEvent: function()
    {
       
      $(".carosel01 .img_next_Btn").on("click", imgNavigation.buttonCallbackfuntionNext)
      $(".carosel01 .img_prev_Btn").on("click", imgNavigation.buttonCallbackfuntionPrev)
    ...
    { 
        ...
        if(imgNavigation.count<=3) 
        {
            $(".carosel01 .img_prev_Btn").css("opacity","1");
            $(".carosel01 .img_prev_Btn").css("cursor","pointer"); 
            $(this).parent().parent().parent().parent().hide();
            $(this).parent().parent().parent().parent().next().show();           
            if(imgNavigation.count==3)
            {
                $(".carosel01 .img_next_Btn").css("opacity",".5");
                $(".carosel01 .img_next_Btn").css("cursor","default"); 
            }
        }
        else
        {
            imgNavigation.count= 3
        }
    ...
    {         
        ...
        {
            $(".carosel01 .img_next_Btn").css("opacity","1");
            $(".carosel01 .img_next_Btn").css("cursor","pointer"); 
            $(this).parent().parent().parent().parent().hide();
...
var imgNavigation_1 = 
{
    ...
    init:function()
    {
        imgNavigation_1.buttonEvent();        
        $(".carosel02 .img_prev_Btn").css("opacity",".5");
        $(".carosel02 .img_prev_Btn").css("cursor","default");
    },
    
    buttonEvent: function()
    {      
      $(".carosel02 .img_next_Btn").on("click", imgNavigation_1.buttonCallbackfuntionNext)
      $(".carosel02 .img_prev_Btn").on("click", imgNavigation_1.buttonCallbackfuntionPrev)

    },    
    buttonCallbackfuntionNext: function(event)
    { 
        imgNavigation_1.count=imgNavigation_1.count+1; 
           
        if(imgNavigation_1.count<=3) 
        {
          
            $(".carosel02 .img_prev_Btn").css("opacity","1");
            $(".carosel02 .img_prev_Btn").css("cursor","pointer"); 
            $(this).parent().parent().parent().parent().hide();
            $(this).parent().parent().parent().parent().next().show(); 
                  
            if(imgNavigation_1.count==3)
            {
                $(".carosel02 .img_next_Btn").css("opacity",".5");
                $(".carosel02 .img_next_Btn").css("cursor","default"); 
            }
        }
        else
        {
            imgNavigation_1.count= 3
        }
    ...
    {         
        imgNavigation_1.count = imgNavigation_1.count -1;        
        if(imgNavigation_1.count>=0) 
        {
            $(".carosel02 .img_next_Btn").css("opacity","1");
            $(".carosel02 .img_next_Btn").css("cursor","pointer"); 
            $(this).parent().parent().parent().parent().hide();
            $(this).parent().parent().parent().parent().prev().show();           
            if(imgNavigation_1.count==0)
            {
...
var accordiantemplate = 
{
    ...
    init:function()
    {
        ...
        $(".collapse").on('show.bs.collapse', function () {
            $(this).prev(".card-header").find(".fa")
                .removeClass("fa-plus").addClass("fa-minus");
                $(this).prev().find("button").css("color","#FFFDFB")
